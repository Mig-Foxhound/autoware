...
void getROSParam(std::string* topic_name)
{
  ros::NodeHandle private_node_handle("~");
  private_node_handle.param<std::string>("image_raw_topic", *topic_name, "/image_raw");
  ROS_INFO("image_raw_topic: %s", topic_name->c_str());
}
